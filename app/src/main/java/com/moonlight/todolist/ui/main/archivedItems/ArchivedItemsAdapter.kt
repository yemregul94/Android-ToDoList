...
class ArchivedItemsAdapter : RecyclerView.Adapter<ArchivedItemsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        bind.layoutToDoTask.setOnClickListener {
            val nav = ArchivedItemsFragmentDirections.actionArchivedToDetails(listItem)
